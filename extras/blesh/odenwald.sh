# NOTE: Best used with the appropriate odenwald terminal emulator theme!!!
...
ble-face -s cmdinfo_cd_cdpath fg=#3E9688,bg=black,italic
ble-face -s command_alias fg=blue
ble-face -s command_builtin fg=#96883E
ble-face -s command_directory fg=#3E9688
...
ble-face -s filename_directory fg=#3E9688
...
ble-face -s filename_setuid fg=black,bg=#96883E,underline
...
ble-face -s region bg=#2B685E
ble-face -s region_insert bg=#2B685E
...
ble-face -s syntax_glob fg=#96883E
...
ble-face -s varname_array fg=#96883E
ble-face -s varname_empty fg=#96883E
ble-face -s varname_export fg=#96883E
ble-face -s varname_expr fg=#96883E
ble-face -s varname_hash fg=#96883E
ble-face -s varname_number fg=none
ble-face -s varname_readonly fg=#96883E
ble-face -s varname_transform fg=#96883E
ble-face -s varname_unset bg=red
ble-face -s vbell_erase bg=#2B685E
